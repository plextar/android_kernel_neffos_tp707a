...
ifneq ($(wildcard $(srctree)/drivers/misc/mediatek/dws/$(MTK_PLATFORM)/common/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/codegen.dws),)
  DRVGEN_PATH := drivers/misc/mediatek/dws/$(MTK_PLATFORM)/common/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)
...
#+modify by hzb
ifneq ($(wildcard $(srctree)/tools/dct_tools/DrvGen.py),)
  DRVGEN_TOOL := $(srctree)/tools/dct_tools/DrvGen.py
else
...
$(DTB_OVERLAY_IMAGE_TAGERT) : PRIVATE_MKIMAGE_TOOL:=mkimage
...
$(DTB_OVERLAY_IMAGE_TAGERT) : $(PRIVATE_MULTIPLE_DTB_OVERLAY_OBJ) dtbs apply_dtbo $(PRIVATE_MKIMAGE_TOOL) $(PRIVATE_MKIMAGE_CFG) $(PRIVATE_MULTIPLE_DTB_OVERLAY_HDR)
	...
	$(PRIVATE_MKIMAGE_TOOL) -d $(PRIVATE_MULTIPLE_DTB_OVERLAY_IMG) $(PRIVATE_MKIMAGE_CFG)  > $@
.PHONY: odmdtboimage
