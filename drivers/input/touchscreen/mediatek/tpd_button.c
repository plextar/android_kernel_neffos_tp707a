...
unsigned int ontim_reverse_virtualkey = 0;
...
//add by ontim_yzw for proc interface 0227/2018 begin
                    ...
                    printk(KERN_ERR "[ontim]reverse flag is %d,key num %d,i is %d\n",ontim_reverse_virtualkey,tpd_keycnt,i);
                if(!!ontim_reverse_virtualkey){
                    i = tpd_keycnt-1-i;
                }
                    printk(KERN_ERR "[ontim]reverse flag is %d,key num %d,i is %d\n",ontim_reverse_virtualkey,tpd_keycnt,i);
#endif
//add by ontim_yzw for proc interface 0227/2018 iend
