...
#if 1
static  char battery_vendor_name[50]="MLP395976 2920mAh";
...
//	sprintf(battery_vendor_name, "%08d;\n",id_volt);
	strncpy(battery_vendor_name,g_battery_id_vendor_name[g_fg_battery_id],20);
