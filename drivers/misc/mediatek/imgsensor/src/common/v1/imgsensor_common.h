...
#define PK_DBG(fmt, arg...)  pr_debug(PREFIX"[%s](%d) "fmt,__FUNCTION__, __LINE__,  ##arg)
#define PK_PR_ERR(fmt, arg...)  pr_err("[%s](%d) "fmt,__FUNCTION__, __LINE__,  ##arg)
#define PK_INFO(fmt, arg...) pr_debug(PREFIX"[%s](%d) "fmt,__FUNCTION__, __LINE__,  ##arg)
#else
