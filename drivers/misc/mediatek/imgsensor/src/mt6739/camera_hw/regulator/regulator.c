...
static enum IMGSENSOR_RETURN regulator_set(
	void *pinstance,
	enum IMGSENSOR_SENSOR_IDX   sensor_idx,// 0=main  1=sub
	enum IMGSENSOR_HW_PIN       pin,//  4=dvdd
	enum IMGSENSOR_HW_PIN_STATE pin_state)// 2=1100  3=1200
{
