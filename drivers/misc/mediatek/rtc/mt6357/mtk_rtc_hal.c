...
/* BEGIN ontim,zhangxiang,2018/03/07,REQ:0299845,control vibrator by RTC register */
void hal_rtc_set_brightness(struct rtc_time *tm)
{
	u16 irqen;
	irqen = rtc_read(RTC_IRQ_EN) & (~RTC_IRQ_EN_BRT);
