...
#define PFX "cam_cal_list.c"

#define CAM_CALINF(format, args...)     pr_info(PFX "[%s](%d) " format, __func__, __LINE__, ##args)
#define CAM_CALDB(format, args...)      pr_debug(PFX "[%s](%d) " format, __func__, __LINE__, ##args)
#define CAM_CALERR(format, args...)     pr_info(PFX "[%s](%d) " format, __func__, __LINE__, ##args)
#else
#define CAM_CALINF(x, ...)
#define CAM_CALDB(x, ...)
#define CAM_CALERR(x, ...)
