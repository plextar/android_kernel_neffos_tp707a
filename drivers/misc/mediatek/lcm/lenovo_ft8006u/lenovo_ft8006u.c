...
static void lcm_suspend(void)
{
    ...
    MDELAY(10);
    LCM_LOGI("%s,lenovo_ft8006ulcm_suspend power shut start\n", __func__);
#if defined(GPIO_LCD_BIAS_ENN_PIN)||defined(GPIO_LCD_BIAS_ENP_PIN)
...
#endif
    LCM_LOGI("%s,lenovo_ft8006ulcm_suspend power shutted over\n", __func__);
...
LCM_DRIVER lenovo_ft8006u_dsi_cmd_lcm_drv = {
    .name = "lenovo_ft8006u",
