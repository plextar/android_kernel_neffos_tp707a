...
void log_store_bootup(void)
{
	...
	/* use another sram_dram_buffer->buf_size for mirror_log buffer size.*/
	free_reserved_memory(sram_dram_buff->buf_addr, sram_dram_buff->buf_addr +
		sram_dram_buff->buf_size + sram_dram_buff->buf_size);
